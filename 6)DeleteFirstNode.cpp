...
int main()
{
    ...
    linkedList1->deleteFirst();//kaç tane yazsarsan en başta ne varsa onu silmeye gider
    linkedList1->deleteFirst();//sonda eğer hiçbirşey kalmazsa silmez ve head boş gösterir
    linkedList1->printList();
