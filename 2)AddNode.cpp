//listenin sonuna yeni node ekleme
//tail yeni eleman göstericek şekil yazmak 
//listenin başında herhangi bir eleman yoksa head ve tail yeni elemanı başa getirerek göstericek
